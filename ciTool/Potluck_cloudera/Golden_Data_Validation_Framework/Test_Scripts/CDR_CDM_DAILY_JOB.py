...
test_obj_run.configUpdateCare("care_cdr_cdm_dailyAggProperties.ini",new_version,"test_v54","/opt/reflex/opt/care/cdm/cdr")

test_obj_run.runJob("care_cdr_cdm_dailyAgg_job_config","CDR_CDM_DAILY_JOB","1475884800",new_version,old_version,tc_title)
